report 50043 "Work Order TC Print"
{
    ApplicationArea = All;
    Caption = 'Work Order TC Print';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/Rpt50043.WorkOrderTC.rdl';
    ...
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            RequestFilterHeading = 'Work Order TC Print';
            ...
            begin
                ...
                if (AmtCheck = 'AND ZERO PAISA ONLY') then
                    AmtWords := AmtWords
                else
                    AmtWords := AmtWords + ' AND ZERO PAISA ONLY';
