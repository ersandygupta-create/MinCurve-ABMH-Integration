report 50041 "Purchase Cr. Memo Print GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/Rpt50041.PurchaseCrMemoPrint.rdl';
    Caption = 'Format - Purchase Credit Note';
        ...
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(DocDt_PurchCrMemoHeader; "Purch. Cr. Memo Hdr."."Document Date")
                    {
                    }
                    ...
                    column(VendorCrNo; "Purch. Cr. Memo Hdr."."Vendor Cr. Memo No.")
                    {
                    }
                    ...
                    column(PostingDesc; "Purch. Cr. Memo Hdr."."Posting Description") { }
                    ...
                    dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
                    {
                        ...
                        column(CGSTPercent; CGSTPer) { }
                        column(SGSTPercent; SGSTPer) { }
                        column(IGSTPercent; IGSTPer) { }
                        column(CessPercent; CessPer) { }
