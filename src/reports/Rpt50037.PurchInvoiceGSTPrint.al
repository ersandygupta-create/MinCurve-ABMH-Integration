report 50037 "Purchase Invoice Print GST"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Format - Purchase Invoice';
    RDLCLayout = './src/reports/Rpt50037.PurchInvoiceGSTPrint.rdl';
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyAdd1; CompanyInfo.Address) { }
                    ...
                    column(VendorBankBranch; VendorBankBranch) { }
                    column(VendorBankAccountNo; VendorBankAccountNo) { }
                    column(VendorBankIFSC; VendorBankIFSC) { }
                    column(VendorBankSWIFT; VendorBankSWIFT) { }
                    ...
                    column(VenPhNo; Vendor."Phone No.") { }
                    ...
                    column(PostDate_PurchInvHeader; "Purch. Inv. Header"."Posting Date")
                    {
                    }
                    ...
                    dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                    {
                        ...
                        column(Shortcut_Dimension_2_Code; "Purch. Inv. Line"."Shortcut Dimension 2 Code")
                        {
                        }
            ...
            begin
                ...
                if VendorBankAccount.FindFirst() then begin
                    ...
                    VendorBankBranch := VendorBankAccount."Bank Branch No.";
                    VendorBankAccountNo := VendorBankAccount."Bank Account No.";
                    VendorBankIFSC := VendorBankAccount."E3 IFSC Code";
                    VendorBankSWIFT := VendorBankAccount."SWIFT Code";
                end;
    ...
    var
        ...
        InvoiceNoCaptionLbl: Label 'Document No.';
        ...
        PurchInvLineLineDiscountCaptionLbl: Label 'Disc %';
        ...
        txtLedgerDescription: Text[50];
        PurchInvLine: Record "Purch. Inv. Line";
        GLAccount: Record "G/L Account";
        VendorBankName: Text[100];
        VendorBankBranch: Text[100];
