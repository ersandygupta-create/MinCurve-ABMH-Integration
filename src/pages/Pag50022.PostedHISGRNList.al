page 50022 "E3 Posted HIS GRN List"
{
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("Posted Via Order No."; Rec."Posted Via Order No.")
                {
                    ToolTip = 'Specifies the value of the Posted Via Order No. field';
                    ApplicationArea = All;
                }
