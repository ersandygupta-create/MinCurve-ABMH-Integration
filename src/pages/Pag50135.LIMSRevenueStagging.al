page 50135 "E3 LIMS Revenue Stagging"
{

    ApplicationArea = All;
    Caption = 'Create Revenue Stagging';
    PageType = List;
    Editable = true;

    SourceTableView = Sorting("Entry No.") where("General Entries Created" = filter(false), "HIS Bill Type" = filter('Revenue'));
