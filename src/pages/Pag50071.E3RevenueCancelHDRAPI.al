page 50071 "E3 Revenue Cancel HDR API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'mindcurve';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'e3RevenueCancelHDRAPI';
    DelayedInsert = true;
    EntityName = 'revenuecancelheader';
    EntitySetName = 'revenuecancelheaders';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            ...
            part(RevenuecancelLine; "E3 Revenue Cancel Line API")
            {
                Caption = 'Lines';
