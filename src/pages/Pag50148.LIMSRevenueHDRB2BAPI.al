page 50148 "POne Revenue HDR B2B API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'mindcurve';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'pOneRevenueHDRAPI';
    DelayedInsert = true;
    EntityName = 'pOneRevenueheaderB2B';
    EntitySetName = 'pOnerevenueheadersB2B';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            ...
            part(RevenueLine; "POne Revenue Line B2B API")
            {
                Caption = 'Lines';
